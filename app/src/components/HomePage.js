...
calltoCheck (text) {
    ...
    axios.get("http://www.omdbapi.com/?s=guardians+of+the+galaxy&apikey=thewdb" )
        .then(res => {
           ...
           //this.state.EventsList.push(List_to);
           //console.log(res.data['Search']);
           this.setState({EventsList: res.data['Search']});
           //list_to = res.data['Search'];
        })
