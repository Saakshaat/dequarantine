class Event {
    ...
    Event({this.attending, this.cap, this.category, this.description, this.endTime, this.eventId, this.imageUrl, this.link, this.name, this.organizer, this.participants, this.startTime});
